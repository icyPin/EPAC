                        ...
                        <div className="bg-card-bg p-8 rounded-lg shadow-xl">
                            ...
                            <form action="#" method="POST">
                                <div className="mb-5">
                                    ...
                                    <input type="text" id="name" name="name" className="bg-input-bg border border-input-border text-dark-text text-sm rounded-lg focus:ring-primary-accent focus:border-primary-accent block w-full p-2.5" placeholder="Name" required value={name} onChange={(e) => setName(e.target.value)} />
                                </div>
                                <div className="mb-5">
                                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-dark-text-on-light">Email Address</label>
                                    <input type="email" id="email" name="email" className="bg-input-bg border border-input-border text-dark-text text-sm rounded-lg focus:ring-primary-accent focus:border-primary-accent block w-full p-2.5" placeholder="email" required value={email} onChange={(e) => setEmail(e.target.value)} />
                                </div>
                                <div className="mb-5">
                                    <label htmlFor="message" className="block mb-2 text-sm font-medium text-dark-text-on-light">Message</label>
                                    <textarea id="message" name="message" rows="4" className="bg-input-bg border border-input-border text-dark-text text-sm rounded-lg focus:ring-primary-accent focus:border-primary-accent block w-full p-2.5" placeholder="Your message..." required value={message} onChange={(e) => setMessage(e.target.value)}>
                                    </textarea>
                                </div>
                                <button type="submit" className="btn-primary w-full" onClick={HandleMessage}>Send Message</button>
                            </form>
                        </div>
